                ...
                <div class="fr-collapse" id="fr-sidemenu-wrapper">
                    ...
                    <div style="border-bottom: 1px solid #EEEEEE;" class="fr-mt-2w">
                      ...
                      <div class="nb-legend">
                        ...
                        <br />
                        <i>Cette visualisation a été créée par le département Etalab de <a href="https://www.numerique.gouv.fr/"><u>la Direction Interministérielle du Numérique (DINUM)</u></a> et son <a href="https://github.com/etalab/explore.data.gouv.fr/blob/main/src/views/AppCarburant.vue"><u>code source est libre.</u></a></i>
                      </div>
                      <br />
                    </div>
                </div>
