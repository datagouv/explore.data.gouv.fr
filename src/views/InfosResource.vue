<template>
  <div class="subheader">
    ...
    <div class="inforessource">
      <!-- <div
        v-if="generalInfos.filetype && generalInfos.filetype === 'excel'"
        class="fr-grid-row fr-grid-row--gutters preventExcel"
      >
        <div class="fr-col-12 fr-col-md-12 fr-col-xl-12">
          Attention, vous avez sélectionné un fichier Excel, les fonctionnalités
          d'analyses sur ce type de fichiers sont limitées.
        </div>
      </div> -->
      <div
        v-if="dgvInfos.resource"
        class="fr-container--fluid fr-p-2w sticky-bar"
      >
            ...
            <div class="fr-grid-row fr-grid-row--gutters fr-grid-row--middle">
              ...
              <div class="fr-col-auto fr-text--sm fr-m-0 text-mention-grey">
                ...
                >
                  <div class="fr-col-auto">
                    Mis à jour le
                    {{ toFrDate(dgvInfos.resource.last_modified) }}
                  </div>
                  <div class="fr-col-auto">
                    <template v-if="dgvInfos.resource.format"
                      >{{ dgvInfos.resource.format }}
                    </template>
                    <template v-if="dgvInfos.resource.filesize"
                      >({{ bytesToSize(dgvInfos.resource.filesize) }})</template
                    >
                  </div>
              ...
              <div class="fr-col-auto" style="width: 100%">
                ...
                >
                  ...
                  <span
                    ...
                    class="fr-ml-1w fr-badge fr-badge--blue-cumulus"
        ...
        <dialog
          aria-labelledby="fr-modal-title-modal-filters"
          role="dialog"
          id="fr-modal-filters"
        ...
        >
          <div class="fr-container--fluid">
            <div class="fr-grid-row fr-grid-row--right">
              <div
                class="fr-col-12 fr-col-sm-7 fr-col-md-5 fr-col-lg-4 fr-col-xl-3"
              >
                <div class="fr-modal__body">
                  ...
                  <div class="fr-modal__content">
                    <h1
                      id="fr-modal-title-modal-filters"
                    ...
                    >
                      ...
                      >
                        <Input :field="getField(filter.field)" showLabel />
                      </div>
                    </div>
                  </div>
                </div>
    ...
    redirectToResource() {
      window.open(
        window.location.origin +
          "/?url=" +
          getResourceUrl(this.selectedResource)
      );
    },
