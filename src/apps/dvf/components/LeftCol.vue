  ...
  <div class="leftCol" :class="leftColOpening">
    ...
    <div v-if="leftColOpen">
        ...
        >
          ...
          <div class="content-dpe">
            <span v-if="parcellesDpeNb > 1">
              Il semble qu'il y ait plusieurs bâtiments sur cette parcelle. Il y
              a donc plusieurs résultats DPE.<br />
            </span>
            <div
            ...
            >
              <span v-if="item['classe_bilan_dpe'] != null">
                ...
                <div v-if="item['nombre_niveau_immeuble'] != null">
                  Immeuble sur
                  <b>{{ item["nombre_niveau_immeuble"] }}</b> niveaux
                </div>
      ...
      <div
        ...
        v-if="level != 'parcelle' && nodata == false"
      >
        ...
        <div class="chart_container">
          <span class="chart_title"
            >Evolution du prix de vente median au m²</span
          >
          ...
          <div class="chart_info_bulle" v-if="hoveredBulle == 'line'">
            ...
            sélectionné et l'échelle sélectionnée. Les prix au m² sont obtenus
            en divisant la valeur foncière du bien par sa surface au sol.
          </div>
        ...
        <div class="chart_container">
          ...
          <div class="chart_info_bulle" v-if="hoveredBulle == 'bar'">
            ...
            barre, vous pouvez voir combien de ventes se sont faites à un
            montant compris dans la tranche de prix affichée.
          </div>
          <bar-chart></bar-chart>
        </div>
      </div>
      ...
      <div class="mutations_container" v-if="level === 'parcelle'">
        ...
        >
          <div class="content">
            ...
            <div class="infos">
              <span
                class="topinfo adresse"
                v-if="p['adresse_nom_voie'] != null"
              >
