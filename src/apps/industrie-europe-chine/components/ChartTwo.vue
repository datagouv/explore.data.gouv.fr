...
export default {
  ...
  methods: {
    async fetchData() {
        ...
        const url = `${baseUrl}/resources/d353484d-d159-45dc-85cf-d4dc5f0ed47f/data/?code_categorie__exact=${categoryId}&window_end__greater=2000&HOME__exact=${encodeURIComponent(countryEn)}&page_size=50`;
