  ...
  methods: {
    async fetchData() {
      try {
        ...
        const url = `${baseUrl}/resources/d5670741-91c2-4000-aba5-793eb4909ee0/data/?code_categorie__exact=${categoryId}&window_end__greater=2000&HOME__exact=${encodeURIComponent(countryEn)}&page_size=50`;
