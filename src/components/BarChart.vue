...
export default {
  ...
  methods: {
    ...
    createChart () {
      ...
      const labels = []
      const datapoints = []
      if(self.valuesx.length != 0 && self.valuesx.length === self.valuesy.length) {
...
<style scoped lang="scss">
  ...
  @import "../../public/utility/overload-fonts.css";
  @import "../../public/utility/dsfr.min.css";
